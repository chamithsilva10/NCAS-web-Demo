    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-foreground mb-4">DIPLOMA IN SMART LIBRARY TECHNOLOGIES</h1>
          <div className="mb-8">
            <Image
              src="/diploma-smart-library.png"
          ...
          <Button asChild size="lg">
            <a href="https://forms.gle/Jgmw4ufsLvgajTkR8" target="_blank" rel="noopener noreferrer">
              Apply Now
            </a>
          </Button>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              The Diploma in Smart Library Technologies is designed to equip library professionals with the skills and knowledge needed to manage modern digital libraries and information systems.
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">September 5, 2025</p>
              </div>
              <div>
        ...
        <Card className="mt-8">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              For more information about the Diploma in Smart Library Technologies program, please contact NCAS.
            </p>
            <div className="mt-4">
